...
namespace bench_generalized {
    ...
    void print_sweep_config(const CliOptions &opts, std::size_t cases) {
        ...
        if(opts.algo == Algo::gdplusk) {
            std::println("  sweep axes: residual correction {} | inner tol {} | inner max iters {} | refined {} | JD B-only {} | adaptive {}",
    ...
    void print_result_header(Algo algo) {
        ...
        if(algo == Algo::lanczos) {
            std::println("{:<5} {:<5} {:<8} {:>5} {:>5} {:>6} {:<4} {:<4} {:<7} {:>10} {:<24} {:>18} {:>12} {:>12} {:>8} {:>8} {:>8} {:>12} {:>12} {:>12}",
                         "case", "rep", "algo", "ncv", "blk", "retain", "ritz", "bm", "refined", "tol", "stop", "eigval", "rnorm", "rrnorm", "iter", "matvec",
                         "outer", "time[s]", "VmRSS", "VmHWM");
            return;
        }

        std::println("{:<5} {:<5} {:<8} {:>5} {:>5} {:<4} {:<4} {:<7} {:>10} {:<24} {:>18} {:>12} {:>12} {:>8} {:>8} {:>8} {:>12} {:>12} {:>12}",
                     "case", "rep", "algo", "ncv", "blk", "ritz", "bm", "refined", "tol", "stop", "eigval", "rnorm", "rrnorm", "iter", "matvec", "outer",
                     "time[s]", "VmRSS", "VmHWM");
    }
        ...
        std::visit(
            [&](const auto &typed_result) {
                ...
                if constexpr(std::is_same_v<ResultType, GdpluskSolveResult>) {
                    ...
                    std::println("{:<5} {:<5} {:>5} {:>5} {:<4} {:<4} {:<17} {:<7} {:<6} {:<8} {:>10.2e} {:>10.2e} {:>7} {:<24} {:>18.10e} {:>12.4e} {:>12.4e} {:>8} {:>8} "
