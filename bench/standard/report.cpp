...
namespace bench_standard {
    ...
    void print_sweep_config(const CliOptions &opts, std::size_t cases) {
        ...
        if(opts.algo == Algo::gdplusk) {
            std::println("  sweep axes: max retain blocks {} | residual correction {} | inner tol {} | inner max iterations {} | refined {} | adaptive {}",
                         fmt::format("{}", opts.max_retain_blocks), opts.residual_correction, fmt::format("{}", opts.inner_tol), fmt::format("{}", opts.inner_max_iters), fmt::format("{}", opts.use_refined_rayleigh_ritz),
    ...
    void print_result_header(Algo algo) {
        if(algo == Algo::gdplusk) {
            std::println("{:<5} {:<5} {:>5} {:>5} {:<4} {:<17} {:<7} {:<8} {:>10} {:>10} {:>7} {:<24} {:>38} {:>28} {:>28} {:>8} {:>8} {:>8} {:>8} {:>8} "
                         "{:>9} {:>12} {:>12} {:>12} {:>12}",
                         "case", "rep", "ncv", "blk", "ritz", "correction", "refined", "adaptive", "abstol", "inner_tol", "inner", "stop", "eigvals",
                         "rnorms_abs", "rnorms_rel", "outer_iter", "matvec", "outer", "inner", "op_inner", "jd_switch", "time[s]", "VmRSS", "VmHWM", "VmPeak");
            return;
        }

        if(algo == Algo::lanczos) {
            std::println("{:<5} {:<5} {:<8} {:>5} {:>5} {:>6} {:<4} {:<7} {:>10} {:<24} {:>38} {:>28} {:>28} {:>8} {:>8} {:>8} {:>12} {:>12} {:>12}", "case",
                         "rep", "algo", "ncv", "blk", "retain", "ritz", "refined", "abstol", "stop", "eigvals", "rnorms_abs", "rnorms_rel", "outer_iter", "matvec",
                         "outer", "time[s]", "VmRSS", "VmHWM");
            return;
        }

        std::println("{:<5} {:<5} {:<8} {:>5} {:>5} {:<4} {:<7} {:>10} {:<24} {:>38} {:>28} {:>28} {:>8} {:>8} {:>8} {:>12} {:>12} {:>12}", "case", "rep",
                     "algo", "ncv", "blk", "ritz", "refined", "abstol", "stop", "eigvals", "rnorms_abs", "rnorms_rel", "outer_iter", "matvec", "outer", "time[s]",
                     "VmRSS", "VmHWM");
    }
        ...
        std::visit(
            [&](const auto &typed_result) {
                ...
                if constexpr(std::is_same_v<ResultType, GdpluskSolveResult>) {
                    ...
                    std::println("{:<5} {:<5} {:>5} {:>5} {:<4} {:<17} {:<7} {:<8} {:>10.2e} {:>10.2e} {:>7} {:<24} {:>38} {:>28} {:>28} {:>8} {:>8} "
                    ...
                    std::println("{:<5} {:<5} {:<8} {:>5} {:>5} {:>6} {:<4} {:<7} {:>10.2e} {:<24} {:>38} {:>28} {:>28} {:>8} {:>8} {:>8} {:>12.6f} "
                                 "{:>12} {:>12}",
                    ...
                    std::println("{:<5} {:<5} {:<8} {:>5} {:>5} {:<4} {:<7} {:>10.2e} {:<24} {:>38} {:>28} {:>28} {:>8} {:>8} {:>8} {:>12.6f} {:>12} "
                                 "{:>12}",
